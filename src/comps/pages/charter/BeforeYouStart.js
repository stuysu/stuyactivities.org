	...
	return (
		<div>
			<Typography paragraph>
				...
				through the <Link to={"/rules"}>Clubs & Pubs Rules</Link>, which
			...
			<Typography paragraph>
				...
				already done that!) and fill out the Chartering form below. Keep
				in mind that your charter will be public, so do your best to
				provide helpful, substantive responses to the questions, and
				avoid including confusing, inappropriate, or incorrect
				information.
			</Typography>

			<Typography paragraph>
				Once you’ve submitted your club’s charter, please allow up to
