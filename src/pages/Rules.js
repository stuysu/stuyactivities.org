	...
	return (
		<div className={classes.main}>
			...
			<Typography>
				<ol>
					<li>
						For an Activity to exist and operate, a charter must be
						submitted and&nbsp;approved by&nbsp;the administrators
						of the Clubs &amp; Pubs department. Please allow up to 2
						weeks for charter approval. When an Activity is fully
						approved and allowed to operate, its charter will be
						visible on the online catalog of the StuyActivities
						website (
					...
					<li>
						A faculty advisor is recommended for all Activities and
						must be present if:
						<ul>
							<li>
					...
					<li>
						...
						StuyActivities website. Any Activity found inactive for
						more than one month may face suspension and revocation
						of their charter.
					</li>
					<li>
					...
					<li>
						The Student Union reserves the right to suspend any
						Activity found to have violated the rules of their
						charter. All Activities MUST abide by what is submitted
						in their charter. If any changes need to be made, the
						Activity leader(s) must edit their charter accordingly
						and have the changes approved.
					</li>
					<li>
			...
			<Typography>
				<ol>
					...
					<li>
						...
						unless the registered Faculty Advisor for the Activity
						is present.
					</li>
					<li>
			...
			<Typography>
				<ol>
					<li>
						All Activities must reserve a room on StuyActivities to
					...
					<li>
						...
						activity on the StuyActivities website.
					</li>
					<li>
					...
					<li>
						...
						lecture halls) for meetings must have all appropriate
						paperwork filled out by the Activity’s Faculty Advisor
						before the event.
						<ul>
							<li>
			...
			<Typography>
				<ol>
					<li>
						...
						provide funding to Activities. Activities may not
					...
					<li>
						...
						<ul>
							<li>
								...
								will email the Activity the tax-exempt form.
							</li>
							<li>
